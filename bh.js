...
// TODO key value would be more appropriate than key dist
...
BinaryHeap.prototype = {
  ...
  push: function(element) {
    const heap_node = new HeapNode(element.key, element.dist);
    // Add the new element to the end of the array.
    this.heap.push(heap_node);
  ...
  decrease_key: function(key, dist) {
  ...
  bubbleUp: function(n) {
    ...
    const element = this.heap[n], score = element.dist;
